...
const spendingScenes: Scene[] = [
  {
    ...
    choices: [
      { text: "省了1400，不买是傻子，直接拿下", result: "你中了「锚定效应」——1999这个原价操控了你的判断。这件衣服可能出厂价就200，标1999只是为了让599看起来便宜。", impact: "-¥599" },
  ...
  },
  {
    ...
    choices: [
      { text: "才35块，日常快乐不能省", result: "35 × 22个工作日 = 每月770元，一年9,240元。一杯不多，但「拿铁效应」的威力在于日积月累。", impact: "-¥770/月" },
      { text: "这周已经点了3次了，今天带保温杯泡茶", result: "你意识到了小额消费的累积效应。不是不能喝，而是从「无意识消费」变成「有意识选择」。", impact: "省¥35", isGood: true },
      { text: "点便宜的，选个12块的柠檬水", result: "折中方案也不错。消费降级不是目的，有意识地控制额度才是关键。一年能少花5,000多。", impact: "-¥12", isGood: true },
    ],
  },
  {
    id: "flash-sale",
    ...
    choices: [
      { text: "冲！限量的不买就没了，先用花呗", result: "限量焦虑+信用消费，两个陷阱叠加。你买的不是鞋，是「怕错过」的焦虑感。下个月花呗账单会提醒你这个决定。", impact: "-¥1299" },
      { text: "确实想要，但这个月超了。下月预算里专门留一笔再说", result: "延迟满足 + 预算管理，双重理性。真正喜欢的东西不会因为晚买一个月就不香了。", impact: "¥0", isGood: true },
      { text: "打开二手平台看看同款，可能便宜好几百", result: "聪明！同样的东西用更低的价格获取，这就是消费者剩余最大化。", impact: "省¥400+", isGood: true },
    ],
  },
  {
    id: "dopamine",
    ...
    choices: [
      { text: "今天辛苦了，买了犒劳自己", result: "「多巴胺消费」——快感来自点击「付款」那一刻，而不是收到东西之后。你上次冲动买的东西，现在还在用吗？", impact: "-¥287" },
      { text: "关掉App，去跑步/听歌/早点睡", result: "找到了不花钱的解压方式。情绪低落时做消费决策，事后后悔概率高达60%。", impact: "¥0", isGood: true },
      { text: "只买书，其他两个明天再看还想不想要", result: "不错，设了一个底线。39块的书是最有价值的那个，其他两个大概率不会再想买。", impact: "-¥39", isGood: true },
    ],
  },
  {
    id: "subscribe",
    ...
    choices: [
      { text: "都是小钱，懒得管", result: "25+15+30+6+12 = 每月88元，一年1,056元。而你至少有两个几乎不用。「订阅疲劳」是现代最隐蔽的财富黑洞。", impact: "-¥1056/年" },
      { text: "现在就取消不用的，至少省掉健身和那个不记得的App", result: "42元/月 × 12 = 一年省504元。5分钟操作，等于给自己发了500块年终奖。", impact: "省¥504/年", isGood: true },
      { text: "全部取消，用到的时候再重新开", result: "激进但有效。大部分订阅服务随时能重开，但自动续费会一直扣到你发现为止。", impact: "省¥1056/年", isGood: true },
    ],
  },
];
